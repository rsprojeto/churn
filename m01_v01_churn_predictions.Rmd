...
**1** The more products the customer has, the less risk of churn.  
**1** Quanto mais produtos o cliente possui, menor é risco de churn.  
...
**5** Male customers are more likely to churn.    
**5** Clientes do sexo masculino tendem mais a churn.  


**6** The greater the number of active years the customer has, the lower the risk of churn.  
**6** Quanto maior o numero de anos ativo o cliente tem, menor é risco de churn.  


**7** Churn rate should be higher for clients from French.  
**7** O churn rate deve ser maior para clientes da França.


**8** The more products the customer has, the less risk of churn.  
**8** Quanto mais produtos o cliente possui, menor é risco de churn.
